...
const legalInfo = {
    policy : [
        {
        title : "Consent",
        content : `By registering and submitting your personal information, you are indicating your consent to the
        ...
        },
        {
            ...
            content : `We collect personally identifiable information from you when you voluntarily provide it to us
        ...
        },
        {
            ...
            content : `We will use the information collected during the registration process to communicate with you
        ...
        },
        {
            ...
            content: `We do not sell or rent your personal information to any third party. We may share your personal
        ...
        },
        {
            ...
            content :`We only allow third-party providers to collect, use, and disclose your information to the extent
        ...
        },
        {
            ...
            content: `You have the right to access, correct, or delete your personal information at any time. You may also
        ...
        {
            title: "Cookies",
            content:`We use cookies to maintain your session and to personalize your experience on our website. We do
        ...
        ,
        {
            ...
            content:`Our website is secured with SSL encryption, and we use industry-standard security measures to
        ...
        {
            title: "Registrations",
            content:`When you register for Tiara, we collect your contact and financial information to process your
        ...
        },
        {
            ...
            content:`We offer multiple modes of payment on our website, including debit card, UPI ID, and other digital
        ...
        },
        {
            ...
            content:`Our website may contain links to other sites that are not owned or operated by us. We are not
            responsible for the privacy practices or content of those sites, and we encourage you to review their
