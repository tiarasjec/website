    ...
    terms: [
        {
            ...
            By visiting our site and/or participating in our college fest TIARA 2024, you engage in our “Service” and agree to be bound by the following terms and conditions (“Terms of Service”, “Terms”), including those additional terms and conditions and policies referenced herein and/or available by hyperlink. These Terms of Service apply to all users of the site, including, without limitation, students, college staff, and all other participants who browse the page.
            Please read these Terms of Service carefully before accessing or participating in TIARA 2024. By accessing or participating in any part of the event, you agree to be bound by these Terms of Service. If you do not agree to all the terms and conditions of this agreement, then you may not participate in the event. If these Terms of Service are considered an offer, acceptance is expressly limited to these Terms of Service.
        ...
        {
            title: "SECTION 1 - TIARA 2024 PARTICIPATION TERMS",
        ...
        {
            title: "SECTION 2 - GENERAL CONDITIONS FOR TIARA 2024 PARTICIPATION            ",
        ...
        {
            title: "SECTION 3 - ACCURACY, COMPLETENESS AND TIMELINESS OF INFORMATION FOR TIARA 2024 PARTICIPATION            ",
            description: `We, the student organizers, and college staff of St. Joseph Engineering College, strive to ensure that all information provided on the TIARA 2024 event platform is accurate, complete, and timely. However, we cannot guarantee the accuracy, completeness, or timeliness of all information provided.
        ...
        {
            title: "SECTION 4 - MODIFICATIONS TO TIARA 2024 AND REGISTRATION PRICES            ",
            description: `Prices for registration and events at TIARA 2024, organized by St. Joseph Engineering College student organizers, are subject to change without notice.
            We reserve the right at any time to modify or discontinue any aspect of TIARA 2024 (or any part or content thereof) without notice at any time.
            St. Joseph Engineering College student organizers and college staff shall not be liable to you or to any third-party for any modification, price change, suspension, or discontinuance of TIARA 2024.
            `,
        },
        {
        ...
        },
        {
            ...
            description: `We reserve the right to refuse attendance or participation in any event or service organized by TIARA 2024, held by St. Joseph Engineering College, to any person who has provided inaccurate, incomplete, or outdated registration or account information.
            ...
            You agree to provide current, complete, and accurate registration and account information for all events and services organized by TIARA 2024. You agree to promptly update your account and other information, including your email address and payment information, so that we can complete your transactions and contact you as needed.
            `,
        },
        {
            title: "SECTION 7 - OPTIONAL TOOLS            ",
            description: `TIARA 2024, held by St. Joseph Engineering College, may provide you with access to third-party tools over which we have no control or input.
            You acknowledge and agree that TIARA 2024 provides access to such tools "as is" and "as available" without any warranties, representations, or conditions of any kind and without any endorsement. We shall have no liability whatsoever arising from or relating to your use of optional third-party tools.
            Any use by you of optional tools offered through TIARA 2024 is entirely at your own risk and discretion, and you should ensure that you are familiar with and approve of the terms on which tools are provided by the relevant third-party provider(s).
            TIARA 2024 may also offer new services and/or features through the event (including the release of new tools and resources). Such new features and/or services shall also be subject to these Terms and Conditions.
        ...
        },
        {
            ...
            description: `If, at our request, you send certain specific submissions related to TIARA 2024, the college fest organized by student organizers of St. Joseph Engineering College (for example, contest entries), or without a request from us, you send creative ideas, suggestions, proposals, plans, or other materials, whether online, by email, by postal mail, or otherwise (collectively, "comments"), you agree that we may, at any time, without restriction, edit, copy, publish, distribute, translate and otherwise use in any medium any comments that you forward to us. We, the college staff, are and shall be under no obligation (1) to maintain any comments in confidence; (2) to pay compensation for any comments; or (3) to respond to any comments.
            We may, but have no obligation to, monitor, edit, or remove content related to TIARA 2024 that we determine in our sole discretion are unlawful, offensive, threatening, libellous, defamatory, pornographic, obscene, or otherwise objectionable or violates any party’s intellectual property or these Terms of Service.
            You agree that your comments related to TIARA 2024 will not violate any right of any third-party, including copyright, trademark, privacy, personality, or other personal or proprietary right. You further agree that your comments will not contain libellous or otherwise unlawful, abusive, or obscene material or contain any computer virus or other malware that could in any way affect the operation of the Service or any related website. You may not use a false e-mail address, pretend to be someone other than yourself, or otherwise mislead us or third parties as to the origin of any comments. You are solely responsible for any comments you make related to TIARA 2024 and their accuracy. We, the college staff, take no responsibility and assume no liability for any comments posted by you or any third-party related to TIARA 2024.
            `,
        },
        {
            title: "SECTION 10 - PERSONAL INFORMATION",
            description: `Your submission of personal information through the TIARA 2024 website is governed by our Privacy Policy. The student organizers and college staff take the privacy of our participants and attendees seriously and are committed to protecting their personal information. Please carefully review our Privacy Policy before submitting any personal information.
            `,
        },
        {
            title: "SECTION 11 - ERRORS, INACCURACIES AND OMISSIONS            ",
            description: `Occasionally there may be information on the TIARA 2024 website or in the Service that contains typographical errors, inaccuracies or omissions that may relate to event details, schedules, locations, pricing, promotions, offers, or any other related information. We reserve the right to correct any errors, inaccuracies, or omissions, and to change or update information without prior notice.
        ...
        },
        {
            ...
            description: `In the event that any provision of these Terms of Service related to TIARA 2024, held by St. Joseph Engineering College, is determined to be unlawful, void or unenforceable, such provision shall nonetheless be enforceable to the fullest extent permitted by applicable law, and the unenforceable portion shall be deemed to be severed from these Terms of Service. Such determination shall not affect the validity and enforceability of any other remaining provisions that remain relevant to TIARA 2024.
            `,
        },
        {
        ...
        },
        {
            ...
            description: `The failure of either the student organizers or the college staff of TIARA 2024, held by St. Joseph Engineering College, to exercise or enforce any right or provision of these Terms of Service shall not constitute a waiver of such right or provision.
            These Terms of Service and any policies or operating rules posted by the student organizers or the college staff in respect to the college fest, TIARA 2024, constitutes the entire agreement and understanding between the student organizers and the college staff, and govern their organization of the fest, superseding any prior or contemporaneous agreements, communications, and proposals, whether oral or written, between them (including, but not limited to, any prior versions of the Terms of Service).
