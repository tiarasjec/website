        ...
        <footer className="text-gray-600 body-font w-full">
            <div className="container w-full px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
                <a href="/" className="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
                    ...
                    <span className=" font-tiara ml-3 text-xl text-white ">Tiara 2024</span>
                </a>
                <p className="text-sm text-white sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4">© 2024 Developed by<a href="https://gdscsjec.in/" className="text-white font-bold ml-1 hover:text-blue-300 transition-all" rel="noopener noreferrer" target="_blank">Google DSC SJEC</a></p>
