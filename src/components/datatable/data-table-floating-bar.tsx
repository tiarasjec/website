    ...
    <div className="fixed inset-x-0 bottom-4 z-50 w-full px-4">
      <div className="w-full overflow-x-auto">
        <div className="mx-auto flex w-fit items-center gap-2 rounded-md border bg-card p-2 shadow-2xl">
          ...
          {isRowSelected &&
          (onUserExport !== undefined || onDelete !== undefined)
            ? "●"
            : ""}
  ...
  return (
    <AlertDialog>
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          <AlertDialogTitle>
            This will permanently delete all selected rows. Are you sure you
            want to proceed?
          </AlertDialogTitle>
          <AlertDialogDescription>
            Are you sure you want to delete all selected rows? You won&apos;t be
